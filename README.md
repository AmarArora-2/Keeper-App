...
## Usage
   ...
   - Create Notes
   - Click on the "Title" field to expand the form
   - Enter note title and content
   - Click the "+" button to save
   - Edit Notes
   - Click the edit icon (pencil) on any note
   - Modify title or content
   - Click save icon to update
   - Delete Notes
   - Long-press the delete icon (trash) for 1 second
   - Note will be deleted with smooth animation
